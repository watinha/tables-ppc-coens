...
\multicolumn{2}{|p{13cm}|}{\xitem TE2: Linguagem de Definição de Dados (DDL): criação, atualização e regras de integridade. (10h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE3: Linguagem de Manipulação de Dados (DML): consultas simples, consultas aninhadas, operações de conjuntos, funções de agregação, inserção, remoção e atualização. (15h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE4: Projeto de Banco de Dados: projeto conceitual, projeto lógico e projeto físico. (20h) } \\
\hline
...
{\cellcolor{blue1} Carga-horária (Horas)} & 90\\\hline
\multicolumn{2}{|p{13cm}|}{\cellcolor{blue1} Temas de Estudo}\\\hline
\multicolumn{2}{|p{13cm}|}{\xitem TE1: Fundamentos de orientação a objetos: definições, artefatos, atributos, métodos, objetos, tipos de classes, operador de casting e o paralelo entre orientação à objetos e o paradigma estruturado (20h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE2: Relacionamento entre classes e objetos: encapsulamento, herança, tipos de polimorfismo e interfaces (15h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE3: Tratamento de exceções: definição, mecanismos de disparo e tratamento e classes de exceção (10h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE4: Desenvolvimento de aplicações: utilização de IDEs para implementação de aplicações utilizando paradigma de orientação à objetos (15h) } \\
\hline
...
{\cellcolor{blue1} Carga-horária (Horas)} & 90\\\hline
\multicolumn{2}{|p{13cm}|}{\cellcolor{blue1} Temas de Estudo}\\\hline
\multicolumn{2}{|p{13cm}|}{\xitem TE1: Algoritmos de ordenação: fundamentos, aplicações e complexidade computacional (12h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE2: Árvore balanceada: operações, busca e aplicações de árvores avl e rubro-negra (14h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE3: Árvore B: operações e aplicações (14h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE4: Grafos: representação, operações, busca e aplicações (20h) } \\
\hline
...
{\cellcolor{blue1} Carga-horária (Horas)} & 90\\\hline
\multicolumn{2}{|p{13cm}|}{\cellcolor{blue1} Temas de Estudo}\\\hline
\multicolumn{2}{|p{13cm}|}{\xitem TE1: Boas práticas de programação: definições, manutenção, segurança e versionamento de software (10h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE2: Linguagem de modelagem unificada (UML): definições, objetivos, exemplos e projeto de implementação com base em documentação (10h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE3: Armazenamento persistente de dados: iteração com banco de dados a partir do paradigma de orientação a objetos (20h) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE4: Threads e concorrência: definições, prioridades, sincronização e aplicações de threads no contexto do mundo do trabalho (20h) } \\
\hline
...
{\cellcolor{blue1} Carga-horária (Horas)} & 60\\\hline
\multicolumn{2}{|p{13cm}|}{\cellcolor{blue1} Temas de Estudo}\\\hline
\multicolumn{2}{|p{13cm}|}{\xitem TE1: Fundamentos de segurança: políticas, modelos de ameaça e mecanismos de segurança. (10 horas) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE2: Criptologia: sistemas criptográficos simétricos, assimétricos, funções de hash e suas aplicações. (15 horas) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE3: Identidade Digital: certificados digitais, assinatura digital, algoritmos de assinatura e aplicações. (10 horas) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE4: Segurança em redes: protocolos, ameaças, ataques e mecanismos de segurança nas camadas de enlace de dados e transporte do modelo OSI. (15 horas) } \\
\multicolumn{2}{|p{13cm}|}{\xitem TE5: Segurança de software: ataques e vulnerabilidades em aplicações, boas práticas de programação e ferramentas de teste de segurança de software (10 horas). } \\
\hline
...
\begin{tabular}{|p{5cm}|p{8cm}|}\hline
{\cellcolor{blue1} Unidade curricular} & \\\hline
{\cellcolor{blue1} Núcleo} & nan\\\hline
